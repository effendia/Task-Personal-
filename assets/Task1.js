function hitungTotalInvestasi(awal, tahun) {
  ...
  // Loop untuk menghitung keuntungan investasi setiap tahunnya
  ...
  console.log(
    `Total uang investor setelah ${tahun} tahun: Rp${total.toLocaleString()}`
  ); // Cetak hasilnya dengan format ribuan
}

// Panggil fungsi untuk menghitung total investasi setelah 2 tahun
